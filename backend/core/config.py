...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "sqlite+aiosqlite:///./eventaccess.db"

    # JWT Authentication (Local Auth Simple)
    jwt_secret_key: str = "dev-secret-key-change-in-production"
    jwt_algorithm: str = "HS256"
    jwt_expire_minutes: int = 60 * 24 * 7  # 7 days

    # Biometric shadow mode
    biometric_enforcement: bool = False
    biometric_match_threshold: float = 0.35
    biometric_model_name: str = "buffalo_l"
    biometric_model_version: str = "insightface-buffalo_l"
